...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "pullQuote",
        text: "Everything essential, nothing noisy."
      },
      {
        type: "media",
        mediaType: "image",
        src: flowspaceYourDay,
        alt: "FlowSpace Your Day dashboard",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "pullQuote",
        text: "From idea to polished visual without fuss."
      },
      {
        type: "media",
        mediaType: "image",
        src: lineupExample2,
        alt: "Lineup Creator poster example",
        caption: "Poster-style output that looks good on social media, in decks, or in print.",
        fullBleed: true
      },
      { type: "heading", level: 2, text: "What it is" },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "pullQuote",
        text: "From a link to polished visuals that are fast, secure, and controllable."
      },
      {
        type: "media",
        mediaType: "image",
        src: blendspaceExample1,
        alt: "Blendspace Studio output example",
        caption: "Product shots generated from a single product URL.",
        fullBleed: true
      },
      { type: "heading", level: 2, text: "What it is" },
      {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "pullQuote",
        text: "A quiet sense of being there with him, not a gimmick."
      },
      {
        type: "media",
        mediaType: "video",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "pullQuote", text: "THE FUTURE REPEATS ITSELF" },
      {
        ...
        mediaType: "image",
        src: ddwConcept,
        alt: "NextBot concept design",
        caption: "The NextBot concept design showcasing the nature-tech fusion.",
        fullBleed: true
      },
