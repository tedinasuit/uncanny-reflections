                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    >
                        ...
                        <div className="space-y-8 text-lg text-muted-foreground leading-relaxed">
                            ...
                            <p>
                                Currently, I'm focused on expanding what’s possible with not just to automate existing tasks, but to create entirely new kinds of interactions. Whether it’s a productivity platform that feels like a quiet workspace or an installation that mirrors your own identity, I want to build things that leave a lasting impression.
                            </p>
